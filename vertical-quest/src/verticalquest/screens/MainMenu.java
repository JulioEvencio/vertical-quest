...
public class MainMenu extends Screen {
	...
	public MainMenu() {
		...
		super.getButtons().add(new Button(StringScreen.NEW_GAME.getValue(), (Game.rendererWidth - Button.getWidthPressed()) / 2, 150, () -> {
			Game.startGame();
			Game.updateGameStatus(GameStatus.RUN);
		}));
		super.getButtons().add(new Button(StringScreen.CREDITS.getValue(), (Game.rendererWidth - Button.getWidthPressed()) / 2, 250, () -> Game.updateGameStatus(GameStatus.CREDITS)));
